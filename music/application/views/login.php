                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form method="post" action='<?php echo base_url() ?>login/index'>
                                        ...
                                        ?>
                                        <div class="form-group"><label class="small mb-1" for="inputEmailAddress">ID / EMAIL</label><input class="form-control py-4" id="inputid" type="text" name='id' placeholder="Masukan ID / Email Anda" required /></div>
                                        <div class="form-group"><label class="small mb-1" for="inputPassword">KATASANDI</label><input class="form-control py-4" id="inputKatasandi" type="password" name='katasandi' placeholder="Masukan Katasandi" required /></div>
